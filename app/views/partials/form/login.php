    ...
    <div class="card border-light-subtle shadow-sm">
      <div class="row g-0">
        <div class="col-12 col-md-6">
          <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="app\views\public\Images\image8.png" alt="BootstrapBrain Logo">
        </div>
        <div class="col-12 col-md-6">
          <div class="card-body p-3 p-md-4 p-xl-5">
            ...
            <form  method="POST" action="?controller=user&action=login&page=customer">
              <div class="row gy-3 gy-md-4 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn bsb-btn-xl btn-primary" value="Log In" name="login" type="submit">Log in now</button>
                  </div>
                </div>
              </div>
            </form>
